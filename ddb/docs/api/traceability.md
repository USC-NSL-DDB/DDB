...
| R-02 explicit contracts | Protobuf plus narrow `operation_policy.json`; validated generated operation registry; generated runtime route/error/stream constants; `ddb-api-types`; descriptor/OpenAPI/AsyncAPI outputs | `api-types/tests/contract.rs`; exact registry/spec coverage checks; codegen `--check`; Redocly/AsyncAPI validation; live-payload JSON Schema tests; Buf/oasdiff/AsyncAPI breaking CI; TypeScript/Python tests |
...
| R-11 security/operations | fail-closed remote bind, token grants/scopes, generated v2 route authorization, origin/rate/concurrency/body policies, safe HTTP/gRPC and bounded-store telemetry, graceful drain | exhaustive registry-driven authorization and OpenAPI identity test; deployment/CORS/rate/shutdown process tests; capture-based sensitive-log test; auth/security/limit unit tests; gRPC process test |
...
- Buf, OpenAPI, and AsyncAPI breaking comparison against the last published
  contracts, deterministic generation, standards validation, and generated
  example/captured-runtime schema conformance;
